...
| Document parsing | **Text + PDF + OCR** | txt/md/csv + PyMuPDF + Tesseract; DOCX open |
...
| **P1.8** | **DOCX / XLSX** | Office files | **Next** when PDF stable |
...
- **Later:** DOCX when PDF path is stable  
...
- ~~`Do A`~~ / ~~`Do B2`~~ / ~~`Do B3`~~ / ~~`Do sources`~~ — **done**  
- `Do DOCX` — Word extract (later)  
